...
- Runtime and transport:
    ...
    - `crates/honk-outbound/src/runtime/tests/dial_admission.rs` — generation/process dial ceilings and retained-credit ownership; `reality/compat_tests.rs` exercises real TLS compatibility, cold/supplied transport admission, cancellation, and setup deadlines.
