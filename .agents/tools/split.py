...
# sha256 of AGENTS.md at 346e667d3387ca7ab1483179f7baf2a66be51aa5.
PINNED_SHA256 = "dd156815876964fb157790704a03ba78f27337922c51c75aec99b808c8144b8a"
...
MANIFEST = (
    ...
    (ROOT, 272, 272),
    (".agents/rules/configuration.md", 273, 345),
    (".agents/rules/deployment.md", 346, 353),
    (".agents/rules/security.md", 354, 361),
    (ROOT, 362, 396),
)
